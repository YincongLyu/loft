...
struct DDLBuilder {
    ...
    explicit DDLBuilder(::flatbuffers::FlatBufferBuilder &_fbb) : fbb_(_fbb) {
...
inline ::flatbuffers::Offset<DDL> CreateDDLDirect(
    ...
    return loft::CreateDDL(
        _fbb, check_point__, db_name__, ddl_sql__, ddl_type__, last_commit, lsn,
        msg_time__, op_type__, scn, seq, table___, tx_seq, tx_time__
    );
}
...
inline bool VerifyDDLBuffer(::flatbuffers::Verifier &verifier) {
...
inline void FinishDDLBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb, ::flatbuffers::Offset<loft::DDL> root
) {
    fbb.Finish(root);
}
