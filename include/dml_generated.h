...
inline const char *EnumNameDataType(DataType e) {
  if (::flatbuffers::IsOutRange(e, DataType_None, DataType_StringData)) return "";
...
inline const char *EnumNameDataMeta(DataMeta e) {
  if (::flatbuffers::IsOutRange(e, DataMeta_NONE, DataMeta_StringVal)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesDataMeta()[index];
}

template<typename T> struct DataMetaTraits {
  static const DataMeta enum_value = DataMeta_NONE;
};

template<> struct DataMetaTraits<loft::LongVal> {
  static const DataMeta enum_value = DataMeta_LongVal;
};

template<> struct DataMetaTraits<loft::DoubleVal> {
  static const DataMeta enum_value = DataMeta_DoubleVal;
};

template<> struct DataMetaTraits<loft::StringVal> {
...
bool VerifyDataMetaVector(::flatbuffers::Verifier &verifier, const ::flatbuffers::Vector<::flatbuffers::Offset<void>> *values, const ::flatbuffers::Vector<uint8_t> *types);
...
inline ::flatbuffers::Offset<LongVal> CreateLongVal(
    ::flatbuffers::FlatBufferBuilder &_fbb,
    int64_t value = 0) {
...
template<> inline const loft::LongVal *kvPair::value_as<loft::LongVal>() const {
  return value_as_LongVal();
}

template<> inline const loft::DoubleVal *kvPair::value_as<loft::DoubleVal>() const {
  return value_as_DoubleVal();
}

template<> inline const loft::StringVal *kvPair::value_as<loft::StringVal>() const {
...
struct DML FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  int16_t dn() const {
    return GetField<int16_t>(VT_DN, 0);
  }
  ...
  int32_t old_data() const {
    return GetField<int32_t>(VT_OLD_DATA, 0);
  }
...
struct DMLBuilder {
  ...
  void add_dn(int16_t dn) {
    fbb_.AddElement<int16_t>(DML::VT_DN, dn, 0);
  }
  ...
  void add_lsn(int64_t lsn) {
    fbb_.AddElement<int64_t>(DML::VT_LSN, lsn, 0);
  }
  ...
  void add_scn(int64_t scn) {
    fbb_.AddElement<int64_t>(DML::VT_SCN, scn, 0);
  }
  void add_seq(int64_t seq) {
    fbb_.AddElement<int64_t>(DML::VT_SEQ, seq, 0);
  }
  ...
  explicit DMLBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
...
inline ::flatbuffers::Offset<DML> CreateDML(
    ...
    ::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<loft::kvPair>>> keys = 0,
...
inline bool VerifyDataMetaVector(::flatbuffers::Verifier &verifier, const ::flatbuffers::Vector<::flatbuffers::Offset<void>> *values, const ::flatbuffers::Vector<uint8_t> *types) {
...
inline bool VerifyDMLBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<loft::DML>(nullptr);
}

inline bool VerifySizePrefixedDMLBuffer(
    ::flatbuffers::Verifier &verifier) {
...
inline void FinishDMLBuffer(
    ...
    ::flatbuffers::Offset<loft::DML> root) {
  fbb.Finish(root);
}
