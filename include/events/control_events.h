...
public:
  ...
  size_t get_data_size() override { return AbstractEvent::FORMAT_DESCRIPTION_HEADER_LEN; }
...
{
public:
  Gtid_event(int64 last_committed_arg, int64 sequence_number_arg, bool may_have_sbr_stmts_arg,
...
protected:
  ...
  static const int FULL_COMMIT_TIMESTAMP_LENGTH = IMMEDIATE_COMMIT_TIMESTAMP_LENGTH + ORIGINAL_COMMIT_TIMESTAMP_LENGTH;
  ...
  static const int FULL_SERVER_VERSION_LENGTH = ORIGINAL_SERVER_VERSION_LENGTH + IMMEDIATE_SERVER_VERSION_LENGTH;
...
public:
  ...
  static const int POST_HEADER_LENGTH = ENCODED_FLAG_LENGTH +               /* flags */
  ...
  */
  ...
  static const int MAX_EVENT_LENGTH = LOG_EVENT_HEADER_LEN + POST_HEADER_LENGTH + MAX_DATA_LENGTH;
  ...
  */
  void set_trx_length(unsigned long long int transaction_length_arg) { transaction_length_ = transaction_length_arg; }
...
{
public:
  Rotate_event(const std::string &new_log_ident_arg, size_t ident_len_arg, uint32 flags_arg, uint64 pos_arg);
