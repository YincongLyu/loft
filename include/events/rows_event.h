...
{
public:
  Table_map_event(const Table_id &tid, uint64 colcnt, const char *dbnam, size_t dblen, const char *tblnam,
      size_t tbllen, const std::vector<mysql::FieldRef> &column_view, uint64 immediate_commit_timestamp_arg);
