...
public:
  ...
  */
  ...
  template <typename T>
  void data_to_binary(std::unique_ptr<uchar[]> &buf, T *data, size_t &data_size, enum_field_types type, size_t length,
      size_t str_length, int precision, int frac)
  {
    switch (type) {
      ...
      case enum_field_types::MYSQL_TYPE_JSON: break;
      case enum_field_types::MYSQL_TYPE_TIMESTAMP: break;
      case enum_field_types::MYSQL_TYPE_TIME: break;
      case enum_field_types::MYSQL_TYPE_DATETIME: break;
      default: break;
    }
    return;
  }
