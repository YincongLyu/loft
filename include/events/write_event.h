...
//        cnt++;
//        if (cnt == 3000000) {
//          auto du = std::chrono::duration_cast<std::chrono::milliseconds>(endTime - startTime).count();
//          LOG_DEBUG("======cnt %ld=============data to binary func one time: %ld s", cnt, du * 10000000000000000);
//        }
//
//        sum += std::chrono::duration_cast<std::chrono::milliseconds>(endTime - startTime).count();
