...
struct DDL FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table
{
  ...
  const ::flatbuffers::String *ddl_sql() const { return GetPointer<const ::flatbuffers::String *>(VT_DDL_SQL); }

  const ::flatbuffers::String *ddl_type() const { return GetPointer<const ::flatbuffers::String *>(VT_DDL_TYPE); }
  ...
  bool Verify(::flatbuffers::Verifier &verifier) const
  {
    return VerifyTableStart(verifier) && VerifyOffset(verifier, VT_CHECK_POINT) &&
           ...
           verifier.VerifyString(db_name()) && VerifyOffset(verifier, VT_DDL_SQL) && verifier.VerifyString(ddl_sql()) &&
           VerifyOffset(verifier, VT_DDL_TYPE) && verifier.VerifyString(ddl_type()) &&
...
struct DDLBuilder
{
  ...
  void add_db_name(::flatbuffers::Offset<::flatbuffers::String> db_name) { fbb_.AddOffset(DDL::VT_DB_NAME, db_name); }

  void add_ddl_sql(::flatbuffers::Offset<::flatbuffers::String> ddl_sql) { fbb_.AddOffset(DDL::VT_DDL_SQL, ddl_sql); }
  ...
  void add_last_commit(int64_t last_commit) { fbb_.AddElement<int64_t>(DDL::VT_LAST_COMMIT, last_commit, 0); }

  void add_lsn(int64_t lsn) { fbb_.AddElement<int64_t>(DDL::VT_LSN, lsn, 0); }
  ...
  void add_op_type(::flatbuffers::Offset<::flatbuffers::String> op_type) { fbb_.AddOffset(DDL::VT_OP_TYPE, op_type); }

  void add_scn(int64_t scn) { fbb_.AddElement<int64_t>(DDL::VT_SCN, scn, 0); }

  void add_seq(int64_t seq) { fbb_.AddElement<int64_t>(DDL::VT_SEQ, seq, 0); }

  void add_table_(::flatbuffers::Offset<::flatbuffers::String> table_) { fbb_.AddOffset(DDL::VT_TABLE_, table_); }

  void add_tx_seq(int64_t tx_seq) { fbb_.AddElement<int64_t>(DDL::VT_TX_SEQ, tx_seq, 0); }

  void add_tx_time(::flatbuffers::Offset<::flatbuffers::String> tx_time) { fbb_.AddOffset(DDL::VT_TX_TIME, tx_time); }

  explicit DDLBuilder(::flatbuffers::FlatBufferBuilder &_fbb) : fbb_(_fbb) { start_ = fbb_.StartTable(); }
...
inline ::flatbuffers::Offset<DDL> CreateDDL(::flatbuffers::FlatBufferBuilder &_fbb,
    ::flatbuffers::Offset<::flatbuffers::String>                              check_point = 0,
    ::flatbuffers::Offset<::flatbuffers::String> db_name = 0, ::flatbuffers::Offset<::flatbuffers::String> ddl_sql = 0,
    ::flatbuffers::Offset<::flatbuffers::String> ddl_type = 0, int64_t last_commit = 0, int64_t lsn = 0,
    ::flatbuffers::Offset<::flatbuffers::String> msg_time = 0, ::flatbuffers::Offset<::flatbuffers::String> op_type = 0,
    int64_t scn = 0, int64_t seq = 0, ::flatbuffers::Offset<::flatbuffers::String> table_ = 0, int64_t tx_seq = 0,
...
inline ::flatbuffers::Offset<DDL> CreateDDLDirect(::flatbuffers::FlatBufferBuilder &_fbb,
    const char *check_point = nullptr, const char *db_name = nullptr, const char *ddl_sql = nullptr,
    const char *ddl_type = nullptr, int64_t last_commit = 0, int64_t lsn = 0, const char *msg_time = nullptr,
    const char *op_type = nullptr, int64_t scn = 0, int64_t seq = 0, const char *table_ = nullptr, int64_t tx_seq = 0,
...
inline const loft::DDL *GetDDL(const void *buf) { return ::flatbuffers::GetRoot<loft::DDL>(buf); }
...
inline bool VerifyDDLBuffer(::flatbuffers::Verifier &verifier) { return verifier.VerifyBuffer<loft::DDL>(nullptr); }

inline bool VerifySizePrefixedDDLBuffer(::flatbuffers::Verifier &verifier)
{
  return verifier.VerifySizePrefixedBuffer<loft::DDL>(nullptr);
}

inline void FinishDDLBuffer(::flatbuffers::FlatBufferBuilder &fbb, ::flatbuffers::Offset<loft::DDL> root)
{
  fbb.Finish(root);
}

inline void FinishSizePrefixedDDLBuffer(::flatbuffers::FlatBufferBuilder &fbb, ::flatbuffers::Offset<loft::DDL> root)
{
