...
public:
  DISALLOW_COPY(Field);
  Field(uint32_t length_arg, bool is_nullable_arg, unsigned char null_bit_arg, const char *field_name_arg);
  ...
  */
  ...
  virtual uint pack_length_from_metadata(uint field_metadata) const { return field_metadata; }

  virtual uint row_pack_length() const { return 0; }

  int save_field_metadata(unsigned char *first_byte) { return do_save_field_metadata(first_byte); }
  ...
  */
  virtual uint32_t data_length(ptrdiff_t row_offset [[maybe_unused]] = 0) const { return pack_length(); }
  ...
  */
  virtual void set_field_index(uint16_t field_index) { m_field_index = field_index; }
...
private:
  virtual int do_save_field_metadata(unsigned char *metadata_ptr [[maybe_unused]]) const { return 0; }
};
...
public:
  ...
  Field_num(uint32_t len_arg, bool is_nullable_arg, unsigned char null_bit_arg, const char *field_name_arg,
  ...
  uint32_t pack_length_from_metadata(uint) const override { return pack_length(); }
};
...
public:
  ...
  uint bin_size;
  // 构造函数
  Field_new_decimal(uint32_t len_arg, bool is_nullable_arg, unsigned char null_bit_arg, const char *field_name_arg,
      uint8_t dec_arg, bool unsigned_arg);
...
public:
  Field_tiny(
      uint32_t len_arg, bool is_nullable_arg, unsigned char null_bit_arg, const char *field_name_arg, bool unsigned_arg)
      : Field_num(len_arg, is_nullable_arg, null_bit_arg, field_name_arg, 0, unsigned_arg)
  {}
...
public:
  ...
  Field_real(uint32_t len_arg, bool is_nullable_arg, unsigned char null_bit_arg, const char *field_name_arg,
      uint8_t dec_arg, bool unsigned_arg)
      : Field_num(len_arg, is_nullable_arg, null_bit_arg, field_name_arg, dec_arg, unsigned_arg),
...
{
public:
  Field_decimal(uint32_t len_arg, bool is_nullable_arg, unsigned char null_bit_arg, const char *field_name_arg,
      uint8_t dec_arg, bool unsigned_arg)
      : Field_real(len_arg, is_nullable_arg, null_bit_arg, field_name_arg, dec_arg, unsigned_arg)
  {}
...
public:
  Field_float(uint32_t len_arg, bool is_nullable_arg, unsigned char null_bit_arg, const char *field_name_arg,
      uint8_t dec_arg, bool unsigned_arg)
      : Field_real(len_arg, is_nullable_arg, null_bit_arg, field_name_arg, dec_arg, unsigned_arg)
  {}
...
public:  // 不考虑精度
  Field_double(uint32_t len_arg, bool is_nullable_arg, unsigned char null_bit_arg, const char *field_name_arg,
      uint8_t dec_arg, bool unsigned_arg)
      : Field_real(len_arg, is_nullable_arg, null_bit_arg, field_name_arg, dec_arg, unsigned_arg)
  {}
...
public:
  Field_temporal(
      bool is_nullable_arg, unsigned char null_bit_arg, const char *field_name_arg, uint32_t len_arg, uint8_t dec_arg)
      : Field(len_arg + ((normalize_dec(dec_arg)) ? normalize_dec(dec_arg) + 1 : 0), is_nullable_arg, null_bit_arg,
            field_name_arg)
  {
...
{
public:
  Field_temporal_with_date(bool is_nullable_arg, unsigned char null_bit_arg, const char *field_name_arg,
      uint8_t int_length_arg, uint8_t dec_arg)
      : Field_temporal(is_nullable_arg, null_bit_arg, field_name_arg, int_length_arg, dec_arg)
  {}
};
...
public:
  Field_temporal_with_date_and_time(
      bool is_nullable_arg, unsigned char null_bit_arg, const char *field_name_arg, uint8_t dec_arg)
      : Field_temporal_with_date(is_nullable_arg, null_bit_arg, field_name_arg, MAX_DATETIME_WIDTH, dec_arg)
  {}
};
...
public:
  ...
  Field_timestamp(uint32_t len_arg, bool is_nullable_arg, unsigned char null_bit_arg, const char *field_name_arg);
...
{
public:
  Field_year(bool is_nullable_arg, unsigned char null_bit_arg, const char *field_name_arg)
...
public:
  ...
  Field_datetime(bool is_nullable_arg, unsigned char null_bit_arg, const char *field_name_arg)
      : Field_temporal_with_date_and_time(is_nullable_arg, null_bit_arg, field_name_arg, 0)
  {}

  Field_datetime(const char *field_name_arg) : Field_temporal_with_date_and_time(false, 0, field_name_arg, 0) {}
...
{
public:
  Field_time_common(bool is_nullable_arg, unsigned char null_bit_arg, const char *field_name_arg, uint8_t dec_arg)
      : Field_temporal(is_nullable_arg, null_bit_arg, field_name_arg, MAX_TIME_WIDTH, dec_arg)
  {}
};
...
{
public:
  Field_time(bool is_nullable_arg, unsigned char null_bit_arg, const char *field_name_arg)
...
{
public:
  Field_str(uint32_t len_arg, bool is_nullable_arg, unsigned char null_bit_arg, const char *field_name_arg);
...
{
public:
  Field_longstr(uint32_t len_arg, bool is_nullable_arg, unsigned char null_bit_arg, const char *field_name_arg)
...
public:
  Field_string(uint32_t len_arg, bool is_nullable_arg, unsigned char null_bit_arg, const char *field_name_arg)
...
public:
  Field_varstring(uint32_t len_arg, uint length_bytes_arg, bool is_nullable_arg, unsigned char null_bit_arg,
  ...
  uint32_t pack_length() const final { return (uint32_t)field_length + length_bytes; }
...
public:
  Field_blob(uint32_t len_arg, bool is_nullable_arg, unsigned char null_bit_arg, const char *field_name_arg,
      bool set_packlength)
      : Field_longstr(len_arg, is_nullable_arg, null_bit_arg, field_name_arg), packlength(4)
  {
    set_flag(BLOB_FLAG);
    if (set_packlength) {
      packlength = len_arg <= 255 ? 1 : len_arg <= 65535 ? 2 : len_arg <= 16777215 ? 3 : 4;
    }
  }
...
public:
  Field_json(
      uint32_t len_arg, bool is_nullable_arg, uint null_bit_arg, const char *field_name_arg, uint blob_pack_length)
      : Field_blob(len_arg, is_nullable_arg, null_bit_arg, field_name_arg, blob_pack_length)
  {}
...
public:
  ...
  Field_enum(uint32_t len_arg, bool is_nullable_arg, unsigned char null_bit_arg, const char *field_name_arg,
      uint packlength_arg)
      : Field_str(len_arg, is_nullable_arg, null_bit_arg, field_name_arg), packlength(packlength_arg)
  {
    set_flag(ENUM_FLAG);
  }
  ...
  uint pack_length_from_metadata(uint field_metadata) const final { return (field_metadata & 0x00ff); }
};

class Field_set final : public Field_enum
{
public:
  Field_set(uint32_t len_arg, bool is_nullable_arg, unsigned char null_bit_arg, const char *field_name_arg,
      uint32_t packlength_arg)
      : Field_enum(len_arg, is_nullable_arg, null_bit_arg, field_name_arg, packlength_arg), empty_set_string("", 0)
  {
...
public:
  ...
  uint          bytes_in_rec;
  Field_bit(uint32_t len_arg, bool is_nullable_arg, unsigned char null_bit_arg, unsigned char bit_ofs_arg,
      const char *field_name_arg);

  enum_field_types type() const final { return MYSQL_TYPE_BIT; }

  uint32_t pack_length() const final { return (uint32_t)(field_length + 7) / 8; }
};
...
auto make_field(const char *field_name, size_t field_length, bool is_unsigned, bool is_nullable, size_t null_bit,
...
inline bool is_temporal_real_type(enum_field_types type)
{
  switch (type) {
    ...
    case MYSQL_TYPE_DATETIME2: return true;
    default: return is_temporal_type(type);
  }
}
