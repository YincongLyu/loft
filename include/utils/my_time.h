...
constexpr const int64_t MYTIME_MAX_VALUE = HAVE_64_BITS_TIME_T ? 32536771199 : std::numeric_limits<int32_t>::max();
...
inline long long int my_packed_time_get_frac_part(long long int i) { return (i % (1LL << 24)); }
